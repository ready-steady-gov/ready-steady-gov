...
(function ($, window, document) {
    ...
    AccessibleMegaMenu.prototype = (function () {
        ...
        _mouseOverHandler = function (event) {
            ...
            //  #vince edit
            //console.log(this.settings.topNavItemClass);
            //console.log($(event.target));

            //console.log($('.nav-menu>.nav-item>a'));

            //console.log(event.target);
            //console.log($(this.menu).get(0));

            //console.log($(this.menu).find("li." + this.settings.topNavItemClass).children(0));
            //console.log($('.nav-menu>.nav-item>a'));
            //console.log($(event.target).find('[aria-expanded=true].' + this.settings.topNavItemClass + '>a'));
            ...
            if(this.menu.find('[aria-expanded=true].' + this.settings.panelClass).length) {    
                ...
                _togglePanel.call(this, event);
                    ...
                    $('.nav-menu>.nav-item>a.sub').bind('click',function (event){event.preventDefault();});
                }
            // /vince edit
